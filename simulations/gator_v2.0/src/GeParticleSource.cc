...
GeParticleSource::GeParticleSource()
{
	...
	m_pMessenger = new GeParticleSourceMessenger(this);
...
void
GeParticleSource::SetParticleDefinition(G4ParticleDefinition * aParticleDefinition)
{
...
void
GeParticleSource::SetEnergyFile(G4String hEnergyFile)
{
...
G4bool
GeParticleSource::ReadEnergySpectrum()
{
...
void
GeParticleSource::ConfineSourceToVolume(G4String hVolumeList)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
GeParticleSource::SetRandomSpherePos()
{
...
void
GeParticleSource::GenerateEnergyFromSpectrum()
{
...
void
GeParticleSource::GeneratePrimaryVertexFromTrack(G4Track *pTrack, G4Event *pEvent)
{
