...
// construct Bosons://///////////////////////////////////////////////////
void GePhysicsList::ConstructMyBosons()
{
  // pseudo-particles
...
// construct Leptons://///////////////////////////////////////////////////
void GePhysicsList::ConstructMyLeptons()
{
  // leptons
...
// construct Hadrons://///////////////////////////////////////////////////
void GePhysicsList::ConstructMyHadrons()
{
 //  mesons
...
void GePhysicsList::ConstructMyShortLiveds()
{
  // ShortLiveds
  ;
}
...
void GePhysicsList::AddTransportation() {
  ...
  while( (*theParticleIterator)() ){
    ...
    if(particleName == "neutron") 
      pmanager->AddDiscreteProcess(new GeMaxTimeCuts());
    // Energy cuts to kill charged (embedded in method) particles:
    pmanager->AddDiscreteProcess(new GeMinEkineCuts());
...
void GePhysicsList::ConstructOp() 
{
...
void GePhysicsList::ConstructHad() 
{
