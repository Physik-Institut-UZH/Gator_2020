...
GeParticleSourceMessenger::GeParticleSourceMessenger(GeParticleSource *pParticleSource):
...
void
GeParticleSourceMessenger::SetNewValue(G4UIcommand * command, G4String newValues)
{
