#ifndef __GEPARTICLESOURCEMESSENGER_H__
#define __GEPARTICLESOURCEMESSENGER_H__
...
{
public:
	GeParticleSourceMessenger(GeParticleSource *pParticleSource);
...
#endif // __GEPARTICLESOURCEMESSENGER_H__
