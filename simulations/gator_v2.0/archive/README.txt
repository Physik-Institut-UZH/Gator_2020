...
// last update May 2018
	...
	on the farm, the main directory is /home/atp/galloway/Gator_sims/gator_v1.2
	
		first load geant4.9.3
		% g4env64b-9.3
		
		// GEOMETRY
		The src folder contains the geometry. Use previous .icc and .ihh files as examples to build a new geometry.
