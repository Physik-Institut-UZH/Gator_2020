//
// File generated by /app/cern/root_v5.34.38/bin/rootcint at Tue Feb 11 16:59:09 2020
...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::BCMTFTemplate*)
   {
      ::BCMTFTemplate *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::BCMTFTemplate),0);
      static ::ROOT::TGenericClassInfo 
         instance("BCMTFTemplate", "./BCMTFTemplate.h", 33,
                  typeid(::BCMTFTemplate), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::BCMTFTemplate*)
   {
   ...
   static void BCMTFTemplate_Dictionary() {
      ::ROOTDict::GenerateInitInstanceLocal((const ::BCMTFTemplate*)0x0)->GetClass();
   }
...
} // end of namespace ROOTDict for class ::BCMTFTemplate
...
/* BCMTFTemplate */
static int G__BCMTFTemplateDict_218_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFTemplateDict_218_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         string* pobj;
...
static int G__BCMTFTemplateDict_218_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         string* pobj;
...
static int G__BCMTFTemplateDict_218_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((BCMTFTemplate*) G__getstructoffset())->GetEfficiency());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFTemplateDict_218_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((BCMTFTemplate*) G__getstructoffset())->GetHistogram());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFTemplateDict_218_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((BCMTFTemplate*) G__getstructoffset())->GetNorm());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFTemplateDict_218_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((BCMTFTemplate*) G__getstructoffset())->GetOriginalNorm());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFTemplateDict_218_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
      {
         TH1D* pobj;
         TH1D xobj = ((BCMTFTemplate*) G__getstructoffset())->FluctuateHistogram(*((string*) G__int(libp->para[0])), (double) G__double(libp->para[1]));
         pobj = new TH1D(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
   ...
   case 1:
      {
         TH1D* pobj;
         TH1D xobj = ((BCMTFTemplate*) G__getstructoffset())->FluctuateHistogram(*((string*) G__int(libp->para[0])));
         pobj = new TH1D(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
   ...
   case 0:
      {
         TH1D* pobj;
         TH1D xobj = ((BCMTFTemplate*) G__getstructoffset())->FluctuateHistogram();
         pobj = new TH1D(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
static int G__BCMTFTemplateDict_218_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((BCMTFTemplate*) G__getstructoffset())->GetFunctionContainer());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFTemplateDict_218_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((BCMTFTemplate*) G__getstructoffset())->GetNBins());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFTemplateDict_218_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFTemplateDict_218_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
      ((BCMTFTemplate*) G__getstructoffset())->SetHistogram((TH1D*) G__int(libp->para[0]), (double) G__double(libp->para[1]));
      G__setnull(result7);
      break;
   case 1:
...
static int G__BCMTFTemplateDict_218_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((BCMTFTemplate*) G__getstructoffset())->SetOrignialNormalization((double) G__double(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFTemplateDict_218_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFTemplateDict_218_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__BCMTFTemplateDict_218_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__BCMTFTemplateDict_218_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
extern "C" void G__cpp_setup_typetableBCMTFTemplateDict() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("TVectorT<Float_t>",117,G__get_linked_tagnum(&G__BCMTFTemplateDictLN_TVectorTlEfloatgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("TVectorT<Double_t>",117,G__get_linked_tagnum(&G__BCMTFTemplateDictLN_TVectorTlEdoublegR),0,-1);
   G__setnewtype(-1,NULL,0);
...
static void G__setup_memvarBCMTFTemplate(void) {
   ...
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"fOriginalNormalization=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__BCMTFTemplateDictLN_TRandom3),-1,-1,4,"fRandom=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncBCMTFTemplate(void) {
   ...
   G__memfunc_setup("BCMTFTemplate",1192,G__BCMTFTemplateDict_218_0_1, 105, G__get_linked_tagnum(&G__BCMTFTemplateDictLN_BCMTFTemplate), -1, 0, 2, 1, 1, 0, 
"C - - 10 - channelname C - - 10 - processname", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetChannelName",1370,G__BCMTFTemplateDict_218_0_2, 117, G__get_linked_tagnum(&G__BCMTFTemplateDictLN_string), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetProcessName",1408,G__BCMTFTemplateDict_218_0_3, 117, G__get_linked_tagnum(&G__BCMTFTemplateDictLN_string), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetEfficiency",1301,G__BCMTFTemplateDict_218_0_4, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetHistogram",1230,G__BCMTFTemplateDict_218_0_5, 85, G__get_linked_tagnum(&G__BCMTFTemplateDictLN_TH1D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetNorm",700,G__BCMTFTemplateDict_218_0_6, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetOriginalNorm",1521,G__BCMTFTemplateDict_218_0_7, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("FluctuateHistogram",1883,G__BCMTFTemplateDict_218_0_8, 117, G__get_linked_tagnum(&G__BCMTFTemplateDictLN_TH1D), -1, 0, 2, 1, 1, 0, 
"u 'string' - 0 '\"GZ\"' options d - - 0 '1' norm", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetFunctionContainer",2057,G__BCMTFTemplateDict_218_0_9, 85, G__get_linked_tagnum(&G__BCMTFTemplateDictLN_vectorlETF1mUcOallocatorlETF1mUgRsPgR), G__defined_typename("vector<TF1*>"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetNBins",762,G__BCMTFTemplateDict_218_0_10, 105, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetEfficiency",1313,G__BCMTFTemplateDict_218_0_11, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 0 - eff", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetHistogram",1242,G__BCMTFTemplateDict_218_0_12, 121, -1, -1, 0, 2, 1, 1, 0, 
"U 'TH1D' - 0 - hist d - - 0 '1' norm", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetOrignialNormalization",2504,G__BCMTFTemplateDict_218_0_13, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 0 - norm", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetFunctionContainer",2069,G__BCMTFTemplateDict_218_0_14, 121, -1, -1, 0, 2, 1, 1, 0, 
"U 'vector<TF1*,allocator<TF1*> >' 'vector<TF1*>' 0 - funccont i - - 0 - nbins", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("BCMTFTemplate", 1192, G__BCMTFTemplateDict_218_0_15, (int) ('i'), G__get_linked_tagnum(&G__BCMTFTemplateDictLN_BCMTFTemplate), -1, 0, 1, 1, 1, 0, "u 'BCMTFTemplate' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~BCMTFTemplate", 1318, G__BCMTFTemplateDict_218_0_16, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__BCMTFTemplateDict_218_0_17, (int) ('u'), G__get_linked_tagnum(&G__BCMTFTemplateDictLN_BCMTFTemplate), -1, 1, 1, 1, 1, 0, "u 'BCMTFTemplate' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
G__linked_taginfo G__BCMTFTemplateDictLN_TVectorTlEfloatgR = { "TVectorT<float>" , 99 , -1 };
G__linked_taginfo G__BCMTFTemplateDictLN_TVectorTlEdoublegR = { "TVectorT<double>" , 99 , -1 };
G__linked_taginfo G__BCMTFTemplateDictLN_TH1D = { "TH1D" , 99 , -1 };
G__linked_taginfo G__BCMTFTemplateDictLN_TRandom3 = { "TRandom3" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtableBCMTFTemplateDict() {
  ...
  G__BCMTFTemplateDictLN_TVectorTlEfloatgR.tagnum = -1 ;
  G__BCMTFTemplateDictLN_TVectorTlEdoublegR.tagnum = -1 ;
  G__BCMTFTemplateDictLN_TH1D.tagnum = -1 ;
  G__BCMTFTemplateDictLN_TRandom3.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableBCMTFTemplateDict() {
   ...
   G__get_linked_tagnum_fwd(&G__BCMTFTemplateDictLN_TVectorTlEfloatgR);
   G__get_linked_tagnum_fwd(&G__BCMTFTemplateDictLN_TVectorTlEdoublegR);
   G__get_linked_tagnum_fwd(&G__BCMTFTemplateDictLN_TH1D);
   G__get_linked_tagnum_fwd(&G__BCMTFTemplateDictLN_TRandom3);
