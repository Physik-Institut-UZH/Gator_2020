...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::BCMTFChannel*)
   {
      ::BCMTFChannel *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::BCMTFChannel),0);
      static ::ROOT::TGenericClassInfo 
         instance("BCMTFChannel", "./BCMTFChannel.h", 34,
                  typeid(::BCMTFChannel), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::BCMTFChannel*)
   {
   ...
   static void BCMTFChannel_Dictionary() {
      ::ROOTDict::GenerateInitInstanceLocal((const ::BCMTFChannel*)0x0)->GetClass();
   }
...
} // end of namespace ROOTDict for class ::BCMTFChannel
...
/* BCMTFChannel */
static int G__BCMTFChannelDict_219_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   BCMTFChannel* p = NULL;
...
static int G__BCMTFChannelDict_219_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         string* pobj;
...
static int G__BCMTFChannelDict_219_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((BCMTFChannel*) G__getstructoffset())->GetData());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFChannelDict_219_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((BCMTFChannel*) G__getstructoffset())->GetTemplate((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFChannelDict_219_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((BCMTFChannel*) G__getstructoffset())->GetSystematicVariation((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFChannelDict_219_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((BCMTFChannel*) G__getstructoffset())->GetFlagChannelActive());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFChannelDict_219_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((BCMTFChannel*) G__getstructoffset())->GetHistUncertaintyBandExpectation());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFChannelDict_219_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((BCMTFChannel*) G__getstructoffset())->GetHistUncertaintyBandPoisson());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFChannelDict_219_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((BCMTFChannel*) G__getstructoffset())->GetRangeYMin());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFChannelDict_219_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((BCMTFChannel*) G__getstructoffset())->GetRangeYMax());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFChannelDict_219_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFChannelDict_219_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFChannelDict_219_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFChannelDict_219_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFChannelDict_219_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFChannelDict_219_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFChannelDict_219_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFChannelDict_219_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFChannelDict_219_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFChannelDict_219_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFChannelDict_219_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((BCMTFChannel*) G__getstructoffset())->PrintTemplates(*((string*) G__int(libp->para[0])));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFChannelDict_219_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFChannelDict_219_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFChannelDict_219_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
      ((BCMTFChannel*) G__getstructoffset())->PrintHistUncertaintyBandPoisson((const char*) G__int(libp->para[0]), (const char*) G__int(libp->para[1]));
      G__setnull(result7);
      break;
   case 1:
...
static int G__BCMTFChannelDict_219_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFChannelDict_219_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((BCMTFChannel*) G__getstructoffset())->PrintUncertaintyBandPoisson((const char*) G__int(libp->para[0]), (double) G__double(libp->para[1])
...
static int G__BCMTFChannelDict_219_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__BCMTFChannelDict_219_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__BCMTFChannelDict_219_0_29(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memfuncBCMTFChannel(void) {
   ...
   G__memfunc_setup("BCMTFChannel",1061,G__BCMTFChannelDict_219_0_1, 105, G__get_linked_tagnum(&G__BCMTFChannelDictLN_BCMTFChannel), -1, 0, 1, 1, 1, 0, "C - - 10 - name", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetName",673,G__BCMTFChannelDict_219_0_2, 117, G__get_linked_tagnum(&G__BCMTFChannelDictLN_string), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetData",666,G__BCMTFChannelDict_219_0_3, 85, G__get_linked_tagnum(&G__BCMTFChannelDictLN_BCMTFTemplate), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetTemplate",1116,G__BCMTFChannelDict_219_0_4, 85, G__get_linked_tagnum(&G__BCMTFChannelDictLN_BCMTFTemplate), -1, 0, 1, 1, 1, 0, "i - - 0 - index", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetSystematicVariation",2291,G__BCMTFChannelDict_219_0_5, 85, G__get_linked_tagnum(&G__BCMTFChannelDictLN_BCMTFSystematicVariation), -1, 0, 1, 1, 1, 0, "i - - 0 - index", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetFlagChannelActive",1967,G__BCMTFChannelDict_219_0_6, 103, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetHistUncertaintyBandExpectation",3399,G__BCMTFChannelDict_219_0_7, 85, G__get_linked_tagnum(&G__BCMTFChannelDictLN_TH2D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetHistUncertaintyBandPoisson",2990,G__BCMTFChannelDict_219_0_8, 85, G__get_linked_tagnum(&G__BCMTFChannelDictLN_TH2D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetRangeYMin",1162,G__BCMTFChannelDict_219_0_9, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetRangeYMax",1164,G__BCMTFChannelDict_219_0_10, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetName",685,G__BCMTFChannelDict_219_0_11, 121, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - name", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetData",678,G__BCMTFChannelDict_219_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "U 'BCMTFTemplate' - 0 - bctemplate", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetHistUncertaintyBandExpectation",3411,G__BCMTFChannelDict_219_0_13, 121, -1, -1, 0, 1, 1, 1, 0, "U 'TH2D' - 0 - hist", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetHistUncertaintyBandPoisson",3002,G__BCMTFChannelDict_219_0_14, 121, -1, -1, 0, 1, 1, 1, 0, "U 'TH2D' - 0 - hist", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetFlagChannelActive",1979,G__BCMTFChannelDict_219_0_15, 121, -1, -1, 0, 1, 1, 1, 0, "g - - 0 - flag", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetRangeY",882,G__BCMTFChannelDict_219_0_16, 121, -1, -1, 0, 2, 1, 1, 0, 
"d - - 0 - min d - - 0 - max", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddTemplate",1093,G__BCMTFChannelDict_219_0_17, 121, -1, -1, 0, 1, 1, 1, 0, "U 'BCMTFTemplate' - 0 - bctemplate", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddSystematicVariation",2268,G__BCMTFChannelDict_219_0_18, 121, -1, -1, 0, 1, 1, 1, 0, "U 'BCMTFSystematicVariation' - 0 - variation", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("CalculateHistUncertaintyBandPoisson",3612,G__BCMTFChannelDict_219_0_19, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("CalculateUncertaintyBandPoisson",3204,G__BCMTFChannelDict_219_0_20, 85, G__get_linked_tagnum(&G__BCMTFChannelDictLN_TH1D), -1, 0, 3, 1, 1, 0, 
"d - - 0 - minimum d - - 0 - maximumm "
"i - - 0 - color", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("PrintTemplates",1468,G__BCMTFChannelDict_219_0_21, 121, -1, -1, 0, 1, 1, 1, 0, "u 'string' - 0 - filename", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("PrintTemplate",1353,G__BCMTFChannelDict_219_0_22, 121, -1, -1, 0, 2, 1, 1, 0, 
"i - - 0 - index C - - 10 - filename", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("PrintHistUncertaintyBandExpectation",3636,G__BCMTFChannelDict_219_0_23, 121, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - filename", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("PrintHistUncertaintyBandPoisson",3227,G__BCMTFChannelDict_219_0_24, 121, -1, -1, 0, 2, 1, 1, 0, 
"C - - 10 - filename C - - 10 '\"COLZ\"' options", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("PrintHistCumulativeUncertaintyBandPoisson",4282,G__BCMTFChannelDict_219_0_25, 121, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - filename", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("PrintUncertaintyBandPoisson",2819,G__BCMTFChannelDict_219_0_26, 121, -1, -1, 0, 4, 1, 1, 0, 
"C - - 10 - filename d - - 0 - minimum "
"d - - 0 - maximum i - - 0 - color", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("BCMTFChannel", 1061, G__BCMTFChannelDict_219_0_27, (int) ('i'), G__get_linked_tagnum(&G__BCMTFChannelDictLN_BCMTFChannel), -1, 0, 1, 1, 1, 0, "u 'BCMTFChannel' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~BCMTFChannel", 1187, G__BCMTFChannelDict_219_0_28, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__BCMTFChannelDict_219_0_29, (int) ('u'), G__get_linked_tagnum(&G__BCMTFChannelDictLN_BCMTFChannel), -1, 1, 1, 1, 1, 0, "u 'BCMTFChannel' - 11 - -", (char*) NULL, (void*) NULL, 0);
