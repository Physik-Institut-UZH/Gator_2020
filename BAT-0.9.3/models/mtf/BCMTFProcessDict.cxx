...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::BCMTFProcess*)
   {
      ::BCMTFProcess *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::BCMTFProcess),0);
      static ::ROOT::TGenericClassInfo 
         instance("BCMTFProcess", "./BCMTFProcess.h", 28,
                  typeid(::BCMTFProcess), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::BCMTFProcess*)
   {
   ...
   static void BCMTFProcess_Dictionary() {
      ::ROOTDict::GenerateInitInstanceLocal((const ::BCMTFProcess*)0x0)->GetClass();
   }
...
} // end of namespace ROOTDict for class ::BCMTFProcess
...
{
      G__letint(result7, 105, (long) ((BCMTFProcess*) G__getstructoffset())->GetHistogramColor());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFProcessDict_168_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((BCMTFProcess*) G__getstructoffset())->GetHistogramFillStyle());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFProcessDict_168_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((BCMTFProcess*) G__getstructoffset())->GetHistogramLineStyle());
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__BCMTFProcessDict_168_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((BCMTFProcess*) G__getstructoffset())->SetHistogramColor((int) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFProcessDict_168_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((BCMTFProcess*) G__getstructoffset())->SetHistogramFillStyle((int) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFProcessDict_168_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((BCMTFProcess*) G__getstructoffset())->SetHistogramLineStyle((int) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

// automatic copy constructor
static int G__BCMTFProcessDict_168_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__BCMTFProcessDict_168_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__BCMTFProcessDict_168_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memvarBCMTFProcess(void) {
   ...
   G__memvar_setup((void*)0,105,0,0,-1,-1,-1,4,"fHistogramColor=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,-1,-1,4,"fHistogramFillStyle=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,-1,-1,4,"fHistogramLineStyle=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncBCMTFProcess(void) {
   ...
   G__memfunc_setup("GetHistogramColor",1741,G__BCMTFProcessDict_168_0_3, 105, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetHistogramFillStyle",2150,G__BCMTFProcessDict_168_0_4, 105, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetHistogramLineStyle",2151,G__BCMTFProcessDict_168_0_5, 105, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetName",685,G__BCMTFProcessDict_168_0_6, 121, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - name", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetHistogramColor",1753,G__BCMTFProcessDict_168_0_7, 121, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - color", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetHistogramFillStyle",2162,G__BCMTFProcessDict_168_0_8, 121, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - style", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetHistogramLineStyle",2163,G__BCMTFProcessDict_168_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - style", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("BCMTFProcess", 1099, G__BCMTFProcessDict_168_0_10, (int) ('i'), G__get_linked_tagnum(&G__BCMTFProcessDictLN_BCMTFProcess), -1, 0, 1, 1, 1, 0, "u 'BCMTFProcess' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~BCMTFProcess", 1225, G__BCMTFProcessDict_168_0_11, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__BCMTFProcessDict_168_0_12, (int) ('u'), G__get_linked_tagnum(&G__BCMTFProcessDictLN_BCMTFProcess), -1, 1, 1, 1, 1, 0, "u 'BCMTFProcess' - 11 - -", (char*) NULL, (void*) NULL, 0);
