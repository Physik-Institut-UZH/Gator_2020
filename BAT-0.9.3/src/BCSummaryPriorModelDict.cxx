//
// File generated by /app/cern/root_v5.34.38/bin/rootcint at Tue Feb 11 16:57:08 2020
...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::BCSummaryPriorModel*)
   {
      ::BCSummaryPriorModel *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::BCSummaryPriorModel),0);
      static ::ROOT::TGenericClassInfo 
         instance("BCSummaryPriorModel", "./../BAT/BCSummaryPriorModel.h", 30,
                  typeid(::BCSummaryPriorModel), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::BCSummaryPriorModel*)
   {
   ...
   static void BCSummaryPriorModel_Dictionary() {
      ::ROOTDict::GenerateInitInstanceLocal((const ::BCSummaryPriorModel*)0x0)->GetClass();
   }
...
} // end of namespace ROOTDict for class ::BCSummaryPriorModel
...
/* BCSummaryPriorModel */
static int G__BCSummaryPriorModelDict_244_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCSummaryPriorModelDict_244_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   BCSummaryPriorModel* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__BCSummaryPriorModelDict_244_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCSummaryPriorModelDict_244_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__BCSummaryPriorModelDict_244_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__BCSummaryPriorModelDict_244_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
extern "C" void G__cpp_setup_typetableBCSummaryPriorModelDict() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<unsigned>",117,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_vectorlEunsignedsPintcOallocatorlEunsignedsPintgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<MCMCThreadLocalStorage>",117,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_vectorlEBCEngineMCMCcLcLMCMCThreadLocalStoragecOallocatorlEBCEngineMCMCcLcLMCMCThreadLocalStoragegRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_reverse_iteratorlEvectorlEBCEngineMCMCcLcLMCMCThreadLocalStoragecOallocatorlEBCEngineMCMCcLcLMCMCThreadLocalStoragegRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_vectorlEBCEngineMCMCcLcLMCMCThreadLocalStoragecOallocatorlEBCEngineMCMCcLcLMCMCThreadLocalStoragegRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_reverse_iteratorlEvectorlEBCEngineMCMCcLcLMCMCThreadLocalStoragecOallocatorlEBCEngineMCMCcLcLMCMCThreadLocalStoragegRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_vectorlEBCEngineMCMCcLcLMCMCThreadLocalStoragecOallocatorlEBCEngineMCMCcLcLMCMCThreadLocalStoragegRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<BCEngineMCMC::MCMCThreadLocalStorage>",117,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_vectorlEBCEngineMCMCcLcLMCMCThreadLocalStoragecOallocatorlEBCEngineMCMCcLcLMCMCThreadLocalStoragegRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<BCH1D*>",117,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_vectorlEBCH1DmUcOallocatorlEBCH1DmUgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_reverse_iteratorlEvectorlEBCH1DmUcOallocatorlEBCH1DmUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_vectorlEBCH1DmUcOallocatorlEBCH1DmUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_reverse_iteratorlEvectorlEBCH1DmUcOallocatorlEBCH1DmUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_vectorlEBCH1DmUcOallocatorlEBCH1DmUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<BCH2D*>",117,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_vectorlEBCH2DmUcOallocatorlEBCH2DmUgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_reverse_iteratorlEvectorlEBCH2DmUcOallocatorlEBCH2DmUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_vectorlEBCH2DmUcOallocatorlEBCH2DmUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_reverse_iteratorlEvectorlEBCH2DmUcOallocatorlEBCH2DmUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_vectorlEBCH2DmUcOallocatorlEBCH2DmUgRsPgR));
   G__setnewtype(-1,NULL,0);
...
static void G__setup_memfuncBCSummaryPriorModel(void) {
   ...
   G__memfunc_setup("BCSummaryPriorModel",1904,G__BCSummaryPriorModelDict_244_0_1, 105, G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_BCSummaryPriorModel), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("BCSummaryPriorModel",1904,G__BCSummaryPriorModelDict_244_0_2, 105, G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_BCSummaryPriorModel), -1, 0, 1, 1, 1, 0, "C - - 10 - name", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetModel",797,G__BCSummaryPriorModelDict_244_0_3, 121, -1, -1, 0, 1, 1, 1, 0, "U 'BCModel' - 0 - model", (char*)NULL, (void*) NULL, 0);
   ...
   // automatic copy constructor
   G__memfunc_setup("BCSummaryPriorModel", 1904, G__BCSummaryPriorModelDict_244_0_6, (int) ('i'), G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_BCSummaryPriorModel), -1, 0, 1, 1, 1, 0, "u 'BCSummaryPriorModel' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~BCSummaryPriorModel", 2030, G__BCSummaryPriorModelDict_244_0_7, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__BCSummaryPriorModelDict_244_0_8, (int) ('u'), G__get_linked_tagnum(&G__BCSummaryPriorModelDictLN_BCSummaryPriorModel), -1, 1, 1, 1, 1, 0, "u 'BCSummaryPriorModel' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
G__linked_taginfo G__BCSummaryPriorModelDictLN_vectorlEunsignedsPintcOallocatorlEunsignedsPintgRsPgR = { "vector<unsigned int,allocator<unsigned int> >" , 99 , -1 };
...
G__linked_taginfo G__BCSummaryPriorModelDictLN_vectorlEBCEngineMCMCcLcLMCMCThreadLocalStoragecOallocatorlEBCEngineMCMCcLcLMCMCThreadLocalStoragegRsPgR = { "vector<BCEngineMCMC::MCMCThreadLocalStorage,allocator<BCEngineMCMC::MCMCThreadLocalStorage> >" , 99 , -1 };
G__linked_taginfo G__BCSummaryPriorModelDictLN_reverse_iteratorlEvectorlEBCEngineMCMCcLcLMCMCThreadLocalStoragecOallocatorlEBCEngineMCMCcLcLMCMCThreadLocalStoragegRsPgRcLcLiteratorgR = { "reverse_iterator<vector<BCEngineMCMC::MCMCThreadLocalStorage,allocator<BCEngineMCMC::MCMCThreadLocalStorage> >::iterator>" , 99 , -1 };
...
G__linked_taginfo G__BCSummaryPriorModelDictLN_vectorlEBCH1DmUcOallocatorlEBCH1DmUgRsPgR = { "vector<BCH1D*,allocator<BCH1D*> >" , 99 , -1 };
G__linked_taginfo G__BCSummaryPriorModelDictLN_reverse_iteratorlEvectorlEBCH1DmUcOallocatorlEBCH1DmUgRsPgRcLcLiteratorgR = { "reverse_iterator<vector<BCH1D*,allocator<BCH1D*> >::iterator>" , 99 , -1 };
G__linked_taginfo G__BCSummaryPriorModelDictLN_vectorlEBCH2DmUcOallocatorlEBCH2DmUgRsPgR = { "vector<BCH2D*,allocator<BCH2D*> >" , 99 , -1 };
G__linked_taginfo G__BCSummaryPriorModelDictLN_reverse_iteratorlEvectorlEBCH2DmUcOallocatorlEBCH2DmUgRsPgRcLcLiteratorgR = { "reverse_iterator<vector<BCH2D*,allocator<BCH2D*> >::iterator>" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtableBCSummaryPriorModelDict() {
  G__BCSummaryPriorModelDictLN_vectorlEunsignedsPintcOallocatorlEunsignedsPintgRsPgR.tagnum = -1 ;
  ...
  G__BCSummaryPriorModelDictLN_vectorlEBCEngineMCMCcLcLMCMCThreadLocalStoragecOallocatorlEBCEngineMCMCcLcLMCMCThreadLocalStoragegRsPgR.tagnum = -1 ;
  G__BCSummaryPriorModelDictLN_reverse_iteratorlEvectorlEBCEngineMCMCcLcLMCMCThreadLocalStoragecOallocatorlEBCEngineMCMCcLcLMCMCThreadLocalStoragegRsPgRcLcLiteratorgR.tagnum = -1 ;
  ...
  G__BCSummaryPriorModelDictLN_vectorlEBCH1DmUcOallocatorlEBCH1DmUgRsPgR.tagnum = -1 ;
  G__BCSummaryPriorModelDictLN_reverse_iteratorlEvectorlEBCH1DmUcOallocatorlEBCH1DmUgRsPgRcLcLiteratorgR.tagnum = -1 ;
  G__BCSummaryPriorModelDictLN_vectorlEBCH2DmUcOallocatorlEBCH2DmUgRsPgR.tagnum = -1 ;
  G__BCSummaryPriorModelDictLN_reverse_iteratorlEvectorlEBCH2DmUcOallocatorlEBCH2DmUgRsPgRcLcLiteratorgR.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableBCSummaryPriorModelDict() {
   ...
   G__get_linked_tagnum_fwd(&G__BCSummaryPriorModelDictLN_vectorlEunsignedsPintcOallocatorlEunsignedsPintgRsPgR);
   ...
   G__get_linked_tagnum_fwd(&G__BCSummaryPriorModelDictLN_vectorlEBCEngineMCMCcLcLMCMCThreadLocalStoragecOallocatorlEBCEngineMCMCcLcLMCMCThreadLocalStoragegRsPgR);
   G__get_linked_tagnum_fwd(&G__BCSummaryPriorModelDictLN_reverse_iteratorlEvectorlEBCEngineMCMCcLcLMCMCThreadLocalStoragecOallocatorlEBCEngineMCMCcLcLMCMCThreadLocalStoragegRsPgRcLcLiteratorgR);
   ...
   G__get_linked_tagnum_fwd(&G__BCSummaryPriorModelDictLN_vectorlEBCH1DmUcOallocatorlEBCH1DmUgRsPgR);
   G__get_linked_tagnum_fwd(&G__BCSummaryPriorModelDictLN_reverse_iteratorlEvectorlEBCH1DmUcOallocatorlEBCH1DmUgRsPgRcLcLiteratorgR);
   G__get_linked_tagnum_fwd(&G__BCSummaryPriorModelDictLN_vectorlEBCH2DmUcOallocatorlEBCH2DmUgRsPgR);
   G__get_linked_tagnum_fwd(&G__BCSummaryPriorModelDictLN_reverse_iteratorlEvectorlEBCH2DmUcOallocatorlEBCH2DmUgRsPgRcLcLiteratorgR);
