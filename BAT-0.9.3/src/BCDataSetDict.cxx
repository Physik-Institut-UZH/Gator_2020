...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::BCDataSet*)
   {
      ::BCDataSet *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::BCDataSet),0);
      static ::ROOT::TGenericClassInfo 
         instance("BCDataSet", "./../BAT/BCDataSet.h", 38,
                  typeid(::BCDataSet), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::BCDataSet*)
   {
   ...
   static void BCDataSet_Dictionary() {
      ::ROOTDict::GenerateInitInstanceLocal((const ::BCDataSet*)0x0)->GetClass();
   }
...
} // end of namespace ROOTDict for class ::BCDataSet
