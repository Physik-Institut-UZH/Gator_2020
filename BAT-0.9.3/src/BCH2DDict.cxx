...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::BCH2D*)
   {
      ::BCH2D *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::BCH2D),0);
      static ::ROOT::TGenericClassInfo 
         instance("BCH2D", "./../BAT/BCH2D.h", 38,
                  typeid(::BCH2D), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::BCH2D*)
   {
   ...
   static void BCH2D_Dictionary() {
      ::ROOTDict::GenerateInitInstanceLocal((const ::BCH2D*)0x0)->GetClass();
   }
...
} // end of namespace ROOTDict for class ::BCH2D
...
{
      G__letint(result7, 105, (long) ((BCH2D*) G__getstructoffset())->GetColor((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCH2DDict_171_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((BCH2D*) G__getstructoffset())->SetColorScheme((int) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__BCH2DDict_171_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 5:
      ((BCH2D*) G__getstructoffset())->Print((const char*) G__int(libp->para[0]), *((string*) G__int(libp->para[1]))
...
static int G__BCH2DDict_171_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
      ((BCH2D*) G__getstructoffset())->Draw(*((string*) G__int(libp->para[0])), *((vector<double>*) G__int(libp->para[1])));
      G__setnull(result7);
      break;
   case 1:
      ((BCH2D*) G__getstructoffset())->Draw(*((string*) G__int(libp->para[0])));
      G__setnull(result7);
      break;
   case 0:
...
{
      ((BCH2D*) G__getstructoffset())->Draw(*((string*) G__int(libp->para[0])), (double) G__double(libp->para[1]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((BCH2D*) G__getstructoffset())->PrintIntegratedHistogram((const char*) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      G__letdouble(result7, 100, (double) ((BCH2D*) G__getstructoffset())->GetArea((double) G__double(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__BCH2DDict_171_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
      G__letint(result7, 85, (long) ((BCH2D*) G__getstructoffset())->CalculateProfileGraph((int) G__int(libp->para[0]), *((string*) G__int(libp->para[1]))));
      break;
   case 1:
      G__letint(result7, 85, (long) ((BCH2D*) G__getstructoffset())->CalculateProfileGraph((int) G__int(libp->para[0])));
      break;
   }
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__BCH2DDict_171_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 3:
      G__letint(result7, 85, (long) ((BCH2D*) G__getstructoffset())->DrawProfile((int) G__int(libp->para[0]), *((string*) G__int(libp->para[1]))
...
{
      G__letint(result7, 85, (long) ((BCH2D*) G__getstructoffset())->DrawProfileX(*((string*) G__int(libp->para[0])), *((string*) G__int(libp->para[1]))));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCH2DDict_171_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((BCH2D*) G__getstructoffset())->DrawProfileY(*((string*) G__int(libp->para[0])), *((string*) G__int(libp->para[1]))));
   return(1 || funcname || hash || result7 || libp) ;
}

// automatic copy constructor
static int G__BCH2DDict_171_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__BCH2DDict_171_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__BCH2DDict_171_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
extern "C" void G__cpp_setup_typetableBCH2DDict() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<TObject*>",117,G__get_linked_tagnum(&G__BCH2DDictLN_vectorlETObjectmUcOallocatorlETObjectmUgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__BCH2DDictLN_reverse_iteratorlEvectorlETObjectmUcOallocatorlETObjectmUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__BCH2DDictLN_vectorlETObjectmUcOallocatorlETObjectmUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__BCH2DDictLN_reverse_iteratorlEvectorlETObjectmUcOallocatorlETObjectmUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__BCH2DDictLN_vectorlETObjectmUcOallocatorlETObjectmUgRsPgR));
   G__setnewtype(-1,NULL,0);
}
...
static void G__setup_memvarBCH2D(void) {
   ...
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__BCH2DDictLN_vectorlEintcOallocatorlEintgRsPgR),G__defined_typename("vector<int>"),-1,4,"fColors=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__BCH2DDictLN_vectorlETObjectmUcOallocatorlETObjectmUgRsPgR),G__defined_typename("vector<TObject*>"),-1,4,"fROOTObjects=",0,(char*)NULL);
...
static void G__setup_memfuncBCH2D(void) {
   ...
   G__memfunc_setup("BCH2D",323,G__BCH2DDict_171_0_1, 105, G__get_linked_tagnum(&G__BCH2DDictLN_BCH2D), -1, 0, 1, 1, 1, 0, "U 'TH2D' - 0 '0' h", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetHistogram",1230,G__BCH2DDict_171_0_2, 85, G__get_linked_tagnum(&G__BCH2DDictLN_TH2D), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetColor",799,G__BCH2DDict_171_0_3, 105, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - index", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetColorScheme",1408,G__BCH2DDict_171_0_4, 121, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - scheme", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetHistogram",1242,G__BCH2DDict_171_0_5, 121, -1, -1, 0, 1, 1, 1, 0, "U 'TH2D' - 0 - hist", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetGlobalMode",1282,G__BCH2DDict_171_0_6, 121, -1, -1, 0, 1, 1, 1, 0, "D - - 0 - mode", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Print",525,G__BCH2DDict_171_0_7, 121, -1, -1, 0, 5, 1, 1, 0, 
"C - - 10 - filename u 'string' - 0 '\"BTfB3CS1meangmode\"' options "
"u 'vector<double,allocator<double> >' 'vector<double>' 0 'std::vector<double>(0)' intervals i - - 0 '0' ww "
"i - - 0 '0' wh", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Print",525,G__BCH2DDict_171_0_8, 121, -1, -1, 0, 5, 1, 1, 0, 
"C - - 10 - filename u 'string' - 0 - options "
"d - - 0 - interval i - - 0 '0' ww "
"i - - 0 '0' wh", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Draw",398,G__BCH2DDict_171_0_9, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'string' - 0 '\"BTfB3CS1meangmodelmode\"' options u 'vector<double,allocator<double> >' 'vector<double>' 0 'std::vector<double>(0)' intervals", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Draw",398,G__BCH2DDict_171_0_10, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'string' - 0 - options d - - 0 - interval", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("CalculateIntegratedHistogram",2883,G__BCH2DDict_171_0_11, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("PrintIntegratedHistogram",2498,G__BCH2DDict_171_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - filename", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetLevel",792,G__BCH2DDict_171_0_13, 100, -1, -1, 0, 1, 1, 1, 0, "d - - 0 - p", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetArea",665,G__BCH2DDict_171_0_14, 100, -1, -1, 0, 1, 1, 1, 0, "d - - 0 - p", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetNIntervalsY",1407,G__BCH2DDict_171_0_15, 117, G__get_linked_tagnum(&G__BCH2DDictLN_vectorlEintcOallocatorlEintgRsPgR), G__defined_typename("vector<int>"), 0, 2, 1, 1, 0, 
"U 'TH2D' - 0 - h i - - 1 - nfoundmax", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("CalculateProfileGraph",2129,G__BCH2DDict_171_0_16, 85, G__get_linked_tagnum(&G__BCH2DDictLN_TGraph), -1, 0, 2, 1, 1, 0, 
"i - - 0 - axis u 'string' - 0 '\"mode\"' options", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DrawProfile",1119,G__BCH2DDict_171_0_17, 85, G__get_linked_tagnum(&G__BCH2DDictLN_TGraph), -1, 0, 3, 1, 1, 0, 
"i - - 0 - axis u 'string' - 0 - options "
"u 'string' - 0 '\"blacksolid\"' drawoptions", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DrawProfileX",1207,G__BCH2DDict_171_0_18, 85, G__get_linked_tagnum(&G__BCH2DDictLN_TGraph), -1, 0, 2, 1, 1, 0, 
"u 'string' - 0 - options u 'string' - 0 - drawoptions", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DrawProfileY",1208,G__BCH2DDict_171_0_19, 85, G__get_linked_tagnum(&G__BCH2DDictLN_TGraph), -1, 0, 2, 1, 1, 0, 
"u 'string' - 0 - options u 'string' - 0 - drawoptions", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getNextIndex",1239,(G__InterfaceMethod) NULL, 104, -1, -1, 0, 0, 3, 4, 0, "", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("BCH2D", 323, G__BCH2DDict_171_0_21, (int) ('i'), G__get_linked_tagnum(&G__BCH2DDictLN_BCH2D), -1, 0, 1, 1, 1, 0, "u 'BCH2D' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~BCH2D", 449, G__BCH2DDict_171_0_22, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__BCH2DDict_171_0_23, (int) ('u'), G__get_linked_tagnum(&G__BCH2DDictLN_BCH2D), -1, 1, 1, 1, 1, 0, "u 'BCH2D' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
G__linked_taginfo G__BCH2DDictLN_string = { "string" , 99 , -1 };
...
G__linked_taginfo G__BCH2DDictLN_vectorlETObjectmUcOallocatorlETObjectmUgRsPgR = { "vector<TObject*,allocator<TObject*> >" , 99 , -1 };
G__linked_taginfo G__BCH2DDictLN_reverse_iteratorlEvectorlETObjectmUcOallocatorlETObjectmUgRsPgRcLcLiteratorgR = { "reverse_iterator<vector<TObject*,allocator<TObject*> >::iterator>" , 99 , -1 };

/* Reset class/struct taginfo */
extern "C" void G__cpp_reset_tagtableBCH2DDict() {
  G__BCH2DDictLN_vectorlEdoublecOallocatorlEdoublegRsPgR.tagnum = -1 ;
  G__BCH2DDictLN_string.tagnum = -1 ;
  ...
  G__BCH2DDictLN_vectorlETObjectmUcOallocatorlETObjectmUgRsPgR.tagnum = -1 ;
  G__BCH2DDictLN_reverse_iteratorlEvectorlETObjectmUcOallocatorlETObjectmUgRsPgRcLcLiteratorgR.tagnum = -1 ;
}
...
extern "C" void G__cpp_setup_tagtableBCH2DDict() {
   ...
   G__get_linked_tagnum_fwd(&G__BCH2DDictLN_string);
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__BCH2DDictLN_BCH2D),sizeof(BCH2D),-1,1280,(char*)NULL,G__setup_memvarBCH2D,G__setup_memfuncBCH2D);
   ...
   G__get_linked_tagnum_fwd(&G__BCH2DDictLN_vectorlETObjectmUcOallocatorlETObjectmUgRsPgR);
   G__get_linked_tagnum_fwd(&G__BCH2DDictLN_reverse_iteratorlEvectorlETObjectmUcOallocatorlETObjectmUgRsPgRcLcLiteratorgR);
}
