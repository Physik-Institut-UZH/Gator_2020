   ...
   namespace ROOTDict {
      ...
      inline ::ROOT::TGenericClassInfo *GenerateInitInstance()
      {
         static ::ROOT::TGenericClassInfo 
            instance("BCMath", 0 /*version*/, "./../BAT/BCMath.h", 36,
...
{
      G__letdouble(result7, 100, (double) BCMath::LogGammaPDF((double) G__double(libp->para[0]), (double) G__double(libp->para[1])
, (double) G__double(libp->para[2])));
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__BCMathDict_182_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 3:
      G__letdouble(result7, 100, (double) BCMath::LogLogNormal((double) G__double(libp->para[0]), (double) G__double(libp->para[1])
, (double) G__double(libp->para[2])));
      break;
   case 2:
      G__letdouble(result7, 100, (double) BCMath::LogLogNormal((double) G__double(libp->para[0]), (double) G__double(libp->para[1])));
      break;
   case 1:
      G__letdouble(result7, 100, (double) BCMath::LogLogNormal((double) G__double(libp->para[0])));
      break;
   }
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      G__letdouble(result7, 100, (double) BCMath::CorrectPValue(*(double*) G__Doubleref(&libp->para[0]), *(unsigned int*) G__UIntref(&libp->para[1])
, *(unsigned int*) G__UIntref(&libp->para[2])));
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__BCMathDict_182_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 4:
      G__letdouble(result7, 100, (double) BCMath::FastPValue(*(vector<unsigned>*) libp->para[0].ref, *(vector<double>*) libp->para[1].ref
...
extern "C" void G__cpp_setup_typetableBCMathDict() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<unsigned>",117,G__get_linked_tagnum(&G__BCMathDictLN_vectorlEunsignedsPintcOallocatorlEunsignedsPintgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
}
...
"i - - 0 - n i - - 0 - k", (char*)NULL, (void*) G__func2void( (double (*)(int, int))(&BCMath::LogNoverK) ), 0);
   ...
   G__memfunc_setup("Nint",409,G__BCMathDict_182_0_9, 105, -1, -1, 0, 1, 1, 1, 0, "d - - 0 - x", (char*)NULL, (void*) G__func2void( (int (*)(double))(&BCMath::Nint) ), 0);
   G__memfunc_setup("LogBreitWignerNonRel",2002,G__BCMathDict_182_0_10, 100, -1, -1, 0, 4, 1, 1, 0, 
"d - - 0 - x d - - 0 - mean "
"d - - 0 - Gamma g - - 0 'false' norm", (char*)NULL, (void*) G__func2void( (double (*)(double, double, double, bool))(&BCMath::LogBreitWignerNonRel) ), 0);
   G__memfunc_setup("LogBreitWignerRel",1703,G__BCMathDict_182_0_11, 100, -1, -1, 0, 3, 1, 1, 0, 
"d - - 0 - x d - - 0 - mean "
"d - - 0 - Gamma", (char*)NULL, (void*) G__func2void( (double (*)(double, double, double))(&BCMath::LogBreitWignerRel) ), 0);
   G__memfunc_setup("LogChi2",616,G__BCMathDict_182_0_12, 100, -1, -1, 0, 2, 1, 1, 0, 
"d - - 0 - x i - - 0 - n", (char*)NULL, (void*) G__func2void( (double (*)(double, int))(&BCMath::LogChi2) ), 0);
   G__memfunc_setup("LogVoigtian",1123,G__BCMathDict_182_0_13, 100, -1, -1, 0, 3, 1, 1, 0, 
"d - - 0 - x d - - 0 - sigma "
"d - - 0 - gamma", (char*)NULL, (void*) G__func2void( (double (*)(double, double, double))(&BCMath::LogVoigtian) ), 0);
   G__memfunc_setup("LogGammaPDF",991,G__BCMathDict_182_0_14, 100, -1, -1, 0, 3, 1, 1, 0, 
"d - - 0 - x d - - 0 - alpha "
"d - - 0 - beta", (char*)NULL, (void*) G__func2void( (double (*)(double, double, double))(&BCMath::LogGammaPDF) ), 0);
   G__memfunc_setup("LogLogNormal",1197,G__BCMathDict_182_0_15, 100, -1, -1, 0, 3, 1, 1, 0, 
"d - - 0 - x d - - 0 '0' mean "
"d - - 0 '1' sigma", (char*)NULL, (void*) G__func2void( (double (*)(double, double, double))(&BCMath::LogLogNormal) ), 0);
   G__memfunc_setup("RandomChi2",935,G__BCMathDict_182_0_16, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'vector<double,allocator<double> >' 'vector<double>' 1 - randoms i - - 0 - K", (char*)NULL, (void*) G__func2void( (void (*)(vector<double>&, int))(&BCMath::RandomChi2) ), 0);
   G__memfunc_setup("ECDF",274,G__BCMathDict_182_0_17, 85, G__get_linked_tagnum(&G__BCMathDictLN_TH1D), -1, 0, 1, 1, 1, 0, "u 'vector<double,allocator<double> >' 'vector<double>' 11 - data", (char*)NULL, (void*) G__func2void( (TH1D* (*)(const vector<double>&))(&BCMath::ECDF) ), 0);
   G__memfunc_setup("longestRuns",1188,G__BCMathDict_182_0_18, 117, G__get_linked_tagnum(&G__BCMathDictLN_vectorlEintcOallocatorlEintgRsPgR), G__defined_typename("vector<int>"), 0, 1, 1, 1, 0, "u 'vector<bool,allocator<bool> >' 'vector<bool>' 11 - bitStream", (char*)NULL, (void*) G__func2void( (vector<int> (*)(const vector<bool>&))(&BCMath::longestRuns) ), 0);
   G__memfunc_setup("longestRunsChi2",1514,G__BCMathDict_182_0_19, 117, G__get_linked_tagnum(&G__BCMathDictLN_vectorlEdoublecOallocatorlEdoublegRsPgR), G__defined_typename("vector<double>"), 0, 3, 1, 1, 0, 
...
"u 'vector<double,allocator<double> >' 'vector<double>' 11 - sigma", (char*)NULL, (void*) G__func2void( (vector<double> (*)(const vector<double>&, const vector<double>&, const vector<double>&))(&BCMath::longestRunsChi2) ), 0);
   G__memfunc_setup("longestRunFrequency",2019,G__BCMathDict_182_0_20, 100, -1, -1, 0, 2, 1, 1, 0, 
"h - - 0 - longestObserved h - - 0 - nTrials", (char*)NULL, (void*) G__func2void( (double (*)(unsigned int, unsigned int))(&BCMath::longestRunFrequency) ), 0);
   G__memfunc_setup("SplitGaussian",1351,G__BCMathDict_182_0_21, 100, -1, -1, 0, 2, 1, 1, 0, 
"D - - 0 - x D - - 0 - par", (char*)NULL, (void*) G__func2void( (double (*)(double*, double*))(&BCMath::SplitGaussian) ), 0);
   G__memfunc_setup("CacheFactorial",1385,G__BCMathDict_182_0_22, 121, -1, -1, 0, 1, 1, 1, 0, "h - - 0 - n", (char*)NULL, (void*) G__func2void( (void (*)(unsigned int))(&BCMath::CacheFactorial) ), 0);
   G__memfunc_setup("Rvalue",623,G__BCMathDict_182_0_23, 100, -1, -1, 0, 4, 1, 1, 32, 
...
"h - - 11 - chain_length g - - 11 'true' strict", (char*)NULL, (void*) G__func2void( (double (*)(const vector<double>&, const vector<double>&, const unsigned int&, const bool&))(&BCMath::Rvalue) ), 0);
   G__memfunc_setup("CorrectPValue",1311,G__BCMathDict_182_0_24, 100, -1, -1, 0, 3, 1, 1, 32, 
"d - - 11 - pvalue h - - 11 - npar "
"h - - 11 - nobservations", (char*)NULL, (void*) G__func2void( (double (*)(const double&, const unsigned int&, const unsigned int&))(&BCMath::CorrectPValue) ), 0);
   G__memfunc_setup("FastPValue",987,G__BCMathDict_182_0_25, 100, -1, -1, 0, 4, 1, 1, 32, 
"u 'vector<unsigned int,allocator<unsigned int> >' 'vector<unsigned>' 11 - observed u 'vector<double,allocator<double> >' 'vector<double>' 11 - expected "
"h - - 0 '1e5' - h - - 0 '0' -", (char*)NULL, (void*) G__func2void( (double (*)(const vector<unsigned>&, const vector<double>&, unsigned int, unsigned int))(&BCMath::FastPValue) ), 0);
...
G__linked_taginfo G__BCMathDictLN_vectorlEunsignedsPintcOallocatorlEunsignedsPintgRsPgR = { "vector<unsigned int,allocator<unsigned int> >" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtableBCMathDict() {
  G__BCMathDictLN_vectorlEunsignedsPintcOallocatorlEunsignedsPintgRsPgR.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableBCMathDict() {
   ...
   G__get_linked_tagnum_fwd(&G__BCMathDictLN_vectorlEunsignedsPintcOallocatorlEunsignedsPintgRsPgR);
