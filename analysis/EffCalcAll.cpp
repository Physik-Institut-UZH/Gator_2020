...
// below is total number of simulated events (totevents = number per file (typically 10^6) x number of files) 	
	...
	sprintf(DataPath,"/disk/bulk_atp/gator/Simulation_Results/TTX_trial/merged/");
	
	string workdir = "/disk/bulk_atp/gator/Simulation_Results/TTX_trial/effic/";
