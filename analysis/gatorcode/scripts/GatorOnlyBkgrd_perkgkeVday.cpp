...
void GatorOnlyBkgrd_perkgkeVday(){
...
// HARD-CODED VARIABLES
	...
	string outfilename = workdir + string("test.root");	
	string SPEdir = "/home/atp/galloway/Gator_Screening/Data/Background/Background_20151002_to_20160107/SPE/";
	...
	string bgLeg = "Gator Nov. 2017 (5.5 d)";
	string sampleLeg = "Gator Nov. 2017 (5.5 d)";
...
//	leg->SetHeader("scaled by 2013 aquisition time");
