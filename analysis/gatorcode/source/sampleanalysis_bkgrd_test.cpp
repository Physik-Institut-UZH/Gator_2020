...
// hard-coded input variables:
	...
	string datadir = "/home/atp/galloway/Gator_Screening/Data/Background/Background_20151002_to_20160107/SPE"; // This could be BG SPE dir if "BGswitch" is false	
	string workdir = "/home/atp/galloway/Gator_Screening/Data/Background/Background_20151002_to_20160107"; // output files directory
...
//////////////////////////////////////////////////////////////////////////////////////////	
	...
	// output files
	string outfilename = workdir + string("bkgrd.txt");	
	string efftabfilename = workdir + string("bkgrd_eff_null.txt");
	string savefilename = workdir + string("bkgrd.root");
