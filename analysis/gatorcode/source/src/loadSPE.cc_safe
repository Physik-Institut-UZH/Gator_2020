...
TH1F* loadSPE(const char* dir, Double_t& aqtime){
	...
	Double_t time_tmp=0, entry=0, Totalcounts=0, trigrate=0;
	Int_t channel=0;
	...
	for(int iSpe=0; iSpe<nSpe; iSpe++){
		...
		cout <<" Total acquisition time: " << aqtime << endl;
		cout <<" Total acquisition time (d): " << aqtime/86400 << endl;
...
TH1F* loadSpe(const char* dir, Double_t& aqtime){
	...
	for(int iSpe=0; iSpe<nSpe; iSpe++){
		...
		aqtime += time_tmp; //Stored total total acquisition time
		cout <<" Total acquisition time (s): " << aqtime << endl;
		cout <<" Total acquisition time (d): " << aqtime/86400 << endl;
