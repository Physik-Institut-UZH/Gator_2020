...
// hard-coded input variables:
	...
	string datadir = "/home/atp/galloway/Gator_Screening/Data/Samples/PMT_Al_P01N02/SPE"; // This could be BG SPE dir if "BGswitch" is false	
	string workdir = "/home/atp/galloway/Gator_Screening/Data/Samples/PMT_Al_P01N02/"; // output files directory
...
//	string calibdir_bg = "/home/atp/galloway/Gator_Screening/Calibrations/bkgrd_all_201407/"; // calibration file for bkgrd data taken between July 2014 and Oct 2014
	...
	string configdir = "/home/atp/galloway/Gator_sims/Screening/PMT_AlRing/effic"; // location of lines.list generated from sim	

//	Double_t quantity = 1; //This is the sample weight in kg!!!	
	Double_t quantity = 0.506; //This is the sample weight in kg!!! Or can even be the number of the pieces (PMTs e.g.)
...
//////////////////////////////////////////////////////////////////////////////////////////	
	...
	// output files
	string outfilename = workdir + string("PMT_Al_P01N02.txt");	
	string efftabfilename = workdir + string("PMT_Al_P01N02_eff.txt");
	string activityplotfilename = workdir + string("PMT_Al_P01N02_act.png");
	string savefilename = workdir + string("PMT_Al_P01N02.root");
