...
// hard-coded input variables:
	...
	string datadir = "/home/atp/galloway/Gator_Screening/Data/Samples/PMT_R11410/PMT_9/SPE/"; // This could be BG SPE dir if "BGswitch" is false	
	string workdir = "/home/atp/galloway/Gator_Screening/Data/Samples/PMT_R11410/PMT_9/"; // output files directory
	...
	string configdir = "/home/atp/galloway/Gator_Screening/Data/Samples/PMT_R11410/PMT_9/";
...
string linesfilename = configdir + string("137Cslines.list"); //It doesn't matter if the "Eff_rootfile" switch is true. In such a case it is not used at all.
	...
	Double_t quantity = 9; //This is the sample weight in kg!!! Or can even be the number of the pieces (PMTs e.g.)
...
// currently the activity plot being saved is the one with the regular background
