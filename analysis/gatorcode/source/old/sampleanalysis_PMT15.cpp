...
#include "./include/GatorSampleAnalysis.hh"
#include "./include/screenfncs.h"
...
// hard-coded input variables:
	...
	string datadir = "/disk/bulk_atp/shayne/Gator/Gator_analysis/gatorcode/Data/Samples/PMT_R11410/Batch_27/SPE"; // This could be BG SPE dir if "BGswitch" is false	
	string workdir = "/disk/bulk_atp/shayne/Gator/Gator_analysis/gatorcode/Data/Samples/PMT_R11410/Batch_27/"; // output files directory
...
//        string workdir = "/disk/bulk_atp/shayne/Gator/Gator_analysis/gatorcode/Data/Samples/Karl_PMTs/"; // output files directory
	...
	string backgroundSPEdir = "/disk/bulk_atp/shayne/Gator/Gator_analysis/gatorcode/Data/Background_PMTs/PTFE_holders/SPE/";
...
//	string calibdir_bg = "/home/atp/galloway/Gator_Screening/Calibrations/bkgrd_all_201407/"; // calibration file for bkgrd data taken between July 2014 and Oct 2014
	...
	string configdir = "/disk/bulk_atp/shayne/Gator/Gator_analysis/gatorcode/Data/Samples/PMT_R11410/PMT_15"; // location of lines.list generated from sim	
...
//	Double_t quantity = 1; //This is the sample weight in kg!!!	
	Double_t quantity = 1; //This is the sample weight in kg!!! Or can even be the number of the pieces (PMTs e.g.)
...
//////////////////////////////////////////////////////////////////////////////////////////	
	...
	string savefilename = workdir + string("PMT_15.root");
        // output files
//        string outfilename = workdir + string("PMT_Karl.txt");
//        string efftabfilename = workdir + string("PMT_Karl_eff.txt");
//        string activityplotfilename = workdir + string("PMT_Kar_act.png");
//        string savefilename = workdir + string("PMT_Karl.root");
