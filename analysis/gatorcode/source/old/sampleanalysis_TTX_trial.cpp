...
// hard-coded input variables:
	string sample = "TTX_trial";
	
	string datadir = "/disk/bulk_atp/gator/Simulation_Results/TTX_trial/SPE"; // This could be BG SPE dir if "BGswitch" is false	
...
string configdir = "/disk/bulk_atp/gator/Simulation_Results/TTX_trial/effic/";


//	Double_t quantity = 1; //This is the sample weight in kg!!!	
	Double_t quantity = 1.06; //This is the sample weight in kg!!! Or can even be the number of the pieces (PMTs e.g.)
