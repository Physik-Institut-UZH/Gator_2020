...
string formatdigits1(Double_t var, Double_t err, Int_t dig){//By default the digits used for the precision are 2
...
string formatdigits2(Double_t var, Int_t dig){//By default the digits used for the precision are 3
