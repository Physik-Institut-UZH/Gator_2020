...
// HARD-CODED input variables:
	...
	string workdir = GatorSystem + "screening/P01N02/"; //Where the output files are placed
	
	//Directory where are the SPE files relative to the sample 
	string datadir = GatorSystem + "screening/P01N02/SPE/"; //This could be BG SPE dir if "BGswitch" is false
	...
	string outfilename = "P01N02_STD.txt"; //Edit this
	outfilename = workdir + outfilename;
	
	//Table of BRs and efficiencies in wiki format
	string efftabfilename = "P01N02_STD_efftab.txt"; //Edit this
	efftabfilename = workdir + efftabfilename;
	
	//Everything in the root format
	string savefilename = "P01N02_STD.root";
...
// HARD-CODED input stuff is finished.
	...
	analyser->SetQuantityUnit("kg"); //Edit this
