...
//current values set for 2021.02.11 calibration folder

// calib_fcn_fw: f = a * x + b
double a_fw= 0.16466821456875116;
double b_fw = 0.5929430439613557;

//calib_fcn_bw: f = a * x + b
double a_bw = 6.072817408137299;
double b_bw = -3.6008348394024403;
...
double a_res=2.2915224861410103e-08;
double b_res=0.0023050405913129972;
double c_res=6.581930833893481;
//###################################
