...
//current values set for 2021.05 calibration folder

// calib_fcn_fw: f = a * x + b
double a_fw= 0.16480422280063092;
double b_fw = 0.49977182490554006;

//calib_fcn_bw: f = a * x + b
double a_bw = 6.067805684868481;
double b_bw = -3.032518320298931;
...
double a_res=2.742644386110191e-27;
double b_res=0.0025093405555273985;
double c_res=5.959608269371968;
//###################################
